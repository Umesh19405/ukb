<?php include"my_db.php";?>
 <?php
      $bstid = $_POST['bstid'];
  $record = mysqli_query($con,"SELECT * FROM register_student where id ='$bstid'"); 
...
<div id="wraper">
  ...
  <div align="center">
    <input type="submit"  value="Back" class="submit" name="bdtail_back" formaction="view_detail.php">
  </div>
